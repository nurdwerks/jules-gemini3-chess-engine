...
83. **Material Difference Numeric (S)**
...
91. **Move Accuracy Report (L)**
    ...
    *   *Tasks:*
        ...
        - [ ] Classification thresholds (e.g., Blunder > 2.0).
    *   *Testing Plan:* Analyze a game.
    *   *Acceptance Criteria:*
        - [ ] Report generated.
...
93. **Engine vs. Engine Leaderboard (M)**
...
### Epic 10: Data Management (PGN/FEN)
**Size:** Medium (3 days)
...
119. **Copy FEN to Clipboard (URL) (S)**
...
121. **Move History Notation Toggle (S)**
...
128. **En Passant Target Editor (S)**
...
136. **Force Garbage Collection (S)**
...
147. **Variation Tree Visualization (L)**
...
### Epic 14: Accessibility & Audio
**Size:** Medium (3 days)
**Description:** Making the game accessible to all users.

**User Stories:**

158. **Keyboard Navigation (S)**
...
181. **Chess.com API Integration (L)**
...
200. **Credits Screen (S)**
    *   *Description:* List contributors and libraries used.
    *   *Implementation:* (Duplicate of 177, confirm uniqueness or merge). Merged into Misc.
    *   *Tasks:*
        - [ ] Ensure present.
    *   *Testing Plan:* Check.
    *   *Acceptance Criteria:*
