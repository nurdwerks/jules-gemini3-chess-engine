...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const vizIds = ['viz-king-safety', 'viz-mobility', 'viz-utilization', 'viz-piece-tracker', 'viz-outpost', 'viz-weak-square', 'viz-battery', 'viz-xray', 'viz-pin', 'viz-fork', 'viz-discovered']
  vizIds.forEach(id => {
    const el = document.getElementById(id)
    if (el) el.addEventListener('change', () => renderBoard())
  })
